...
;|				programs		   |
;|_________________________________|
;to add more just replace the leter after the hashtag "#"
; the # is ment to stand for windows + your letter and then :: run to execute that program.     
;           #e:: run (path to executable)
;            ^
;where the   ^ is is what you replace.
...
;dolphin filemanager
;windows + f for dolphin filemanager  
#f:: run C:\Program Files\dolphin\bin\dolphin.exe

;geany text editor
; windows + e for geany text editor
#e:: run C:\Program Files\geany\bin\geany.exe 
